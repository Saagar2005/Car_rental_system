...
void Manager:: manager_portal()
{
   ...
   int condition = 1;                       
   char c,damaged,late;
   float fine1, fine2, fine, amount_paid;
   ...
   cout<<"6- Log Out"<<endl;
   cin>>choice;                                   //default taken care of...
   ...
   switch(choice)
   {
    case 1:
            ...
            cin>>operation;                             //checked by default
            ...
            switch(operation)               
            {
              ...
              case 2:
                    ...
                    {
                      CarDB.Display_row(Car_ID); //Ignoring return value since file will always be found
                      ...
                      if(c=='y'|| c=='Y')
                      {
                        ...
                        switch(field)
                        {
                          ...
                          case 3:
                              ...
                              break;
                          case 4:
                              Car_obj.set_condition(Car_obj.Car_ID,!Car_obj.get_condition(Car_obj.Car_ID));
                        ...
                        CarDB.insert_car(Car_obj.Car_ID, Car_obj.model, Car_obj.rent, Car_obj.get_condition(Car_obj.Car_ID));
    ...
    case 3:
            ...
            cout<<"6- Display Cars Rented by a Specific Employee"<<endl;
            ...
            switch(operation)               
            {
              ...
              case 2: 
                    ...
                    else
                    {
                      ...
                      if(c=='y'|| c=='Y')
                      {
                        ...
                        employeeDB.Delete_row(user_ID);  //Ignoring return value since file will always be found
                        employeeDB.insert_employee(employee.user_id, employee.name, employee.password, employee.NumCurrRentedCars, employee.TotalRentedCars, employee.TotalDamagedCars, employee.TotalDelayDays, employee.fine_due);
                        cout<<"Do you want to continue updating? [y=yes/ n=any other character]"<<endl;
                        cin>>c;
                        if(c=='y' || c=='Y')
                          goto CP5;
              ...
              case 6:
                    ...
                    cout<<"\n Please see the cars rented by the employee:"<<endl;
                    RcarDB.DisplayCarsOfRenter("Employee",user_ID);
                    break;
              case 7:
                    cout<<"Enter Employee ID:"<<endl;
                    cin>>user_ID;
                    ...
                    cout<<"Pending amount to be paid:"<<employee.fine_due<<endl;
                    CP6: cout<<"Enter amount paid now:"<<endl;
                    cin>>amount_paid;
                    if(employee.fine_due>=amount_paid)
              ...
              case 8:
                    ...
                    else
                    {
                      ...
                      {
                          cout<<"How much fine is imposed for the damage?"<<endl;
                          cin>>fine2;
                          fine+=fine2;
                          condition = 0;
                      }
                      employee.clear_dues(-fine);
    ...
    case 4:
            ...
            switch(operation)               
            {
              ...
              case 2: 
                    ...
                    {
                      customerDB.Display_row(user_ID); //Ignoring return value since file will always be found
                      cout<<"Are you sure you want to update? [y=yes/ any other character= no]"<<endl;
                      cin>>c;
                      if(c=='y'|| c=='Y')
                      {
                        ...
                        customerDB.insert_customer(customer.user_id, customer.name, customer.password, customer.NumCurrRentedCars, customer.TotalRentedCars, customer.TotalDamagedCars, customer.TotalDelayDays, customer.fine_due);
                        cout<<"Do you want to continue updating? [y=yes/ n=any other character]"<<endl;
                        cin>>c;
                        if(c=='y' || c=='Y')
                          goto CP15;
              ...
              case 6:
                    ...
                    cout<<"\n Please see the cars rented by the customer:"<<endl;
                    RcarDB.DisplayCarsOfRenter("Customer",user_ID);
                    break;
              case 7:
                    cout<<"Enter customer ID:"<<endl;
                    cin>>user_ID;
                    ...
                    cout<<"Pending amount to be paid:"<<customer.fine_due<<endl;
                    CP16: cout<<"Enter amount paid now:"<<endl;
                    cin>>amount_paid;
                    if(customer.fine_due>=amount_paid)
    ...
    case 5:
            ...
            switch(operation)
            {
                ...
                case 2:
                  ...
                  managerDB.Delete_row(user_id);  //Ignoring return value since file will always be found
                ...
                case 3:
                    NumOfManagers = managerDB.count_managers();
                    if(NumOfManagers == 1)
                    {
                       cout<<" Can't delete manager, since only 1 manager is present"<<endl;
                       goto CP9;
                    }
...
// PART-6 MEMBER FUNCTION DEFINITIONS OF CLASS RENTER.............................................
// END OF PART-6..................................................................................

// PART-7 MEMBER FUNCTION DEFINITIONS OF CLASS EMPLOYEE...........................................
...
{
  string* CurRentedCars= NULL;
  cout<<"Please enter new employee details"<<endl;
  cout<<"Enter Name [single word]"<<endl;
  cin>>name;
  cout<<"Enter User ID [single word]"<<endl;
  cin>>user_id;
  cout<<"Enter password [single word]"<<endl;
  cin>>password;
  Employee_database employeeDB;
  employeeDB.insert_employee(name, user_id, password, 0, 0, 0, 0, 0.0);
}
...
void Employee:: clear_dues(float amt_paid)
{
  Employee_database employeeDB;
  employeeDB.Delete_row(user_id);  //Ignoring return value since file will always be found
  employeeDB.insert_employee(user_id, name, password, NumCurrRentedCars, TotalRentedCars, TotalDamagedCars, TotalDelayDays, fine_due-amt_paid);
}
  ...
  switch (choice)
  {
    ...
    case 4:
          ...
          if(NumCurrRentedCars < (record_score - minRecordScore)*10)
          {
              ...
              else
              {
                ...
                if(c=='y'|c=='Y')
                {
                    ...
                    employeeDB.insert_employee(user_id,name,password,NumCurrRentedCars+1,TotalRentedCars+1,TotalDamagedCars,TotalDelayDays,fine_due+rent);
                    CarDB.Delete_row(Car_ID);
                }
                else
                  goto CP21;
          ...
          else
          {
            ...
            cout<<"Sorry! You can't rent more than"<< NumCurrRentedCars<<"based on your record"<<endl;
          }
          break;
    case 5:
          return;
...
// PART-8 MEMBER FUNCTION DEFINITIONS OF CLASS CUSTOMER...........................................
...
void Customer::new_customer()
{
  ...
  custDB.insert_customer(name, user_id, password, 0, 0, 0, 0, 0.0);
}
...
void Customer:: clear_dues(float amt_paid)
{
  Customer_database customerDB;
  customerDB.Delete_row(user_id);  //Ignoring return value since file will always be found
  customerDB.insert_customer(user_id, name, password, NumCurrRentedCars, TotalRentedCars, TotalDamagedCars, TotalDelayDays, fine_due-amt_paid);
}
          ...
          if(NumCurrRentedCars < (record_score - minRecordScore)*10)
          {
              ...
              else
              {
                ...
                if(c=='y'|c=='Y')
                {
                    ...
                    customerDB.insert_customer(user_id,name,password,NumCurrRentedCars+1,TotalRentedCars+1,TotalDamagedCars,TotalDelayDays,fine_due+rent);
                    CarDB.Delete_row(Car_ID);
                }
                else
                  goto CP23;
...
// PART-9 MEMBER FUNCTION DEFINITIONS OF CLASS DATABASE...........................................
int Database:: Display_row(string ID)
{
  ifstream fin;
  fin.open(file);
  vector<string> headings;               //add heading in files...........?????  
  string line,word;
...
// PART-10 MEMBER FUNCTIONS OF CLASS CAR_DATABASE.................................................
...
// PART-11 MEMBER FUNCTIONS OF CLASS RENTED_CAR_DATABASE..........................................
...
// PART-12 MEMBER FUNCTIONS OF CLASS MANAGER_DATABASE.............................................
...
int Manager_database::count_managers()
{
  ifstream fin;
  fin.open("Managers.csv");
  string line;
...
// PART-13 MEMBER FUNCTIONS OF CLASS EMPLOYEE_DATABASE............................................
void Employee_database:: insert_employee(string user_id, string name, string password, int NumCurrRentedCars, int TotalRentedCars, int TotalDamagedCars, int TotalDelayDays, float fine_due)
{
  ofstream file_write;
  file_write.open("Employees.csv",ios::app);
  file_write<<user_id<<","<<name<<","<<password<<","<<NumCurrRentedCars<<","<<TotalRentedCars<<","<<TotalDamagedCars<<","<<TotalDelayDays<<","<<fine_due<<",";
  file_write.close();
}
// END OF PART-13.................................................................................

// PART-14 MEMBER FUNCTIONS OF CLASS CUSTOMER_DATABASE............................................
void Customer_database:: insert_customer(string user_id, string name, string password, int NumCurrRentedCars, int TotalRentedCars, int TotalDamagedCars, int TotalDelayDays, float fine_due)
{
  ofstream file_write;
